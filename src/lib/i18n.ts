...
export const DICT = {
  en: {
    ...
    expire: 'Expire',
    roll: 'Roll',
    rollAction: 'Roll Options',
    netCredit: 'Net Credit',
    netDebit: 'Net Debit',
    leg1: 'Close Existing',
    leg2: 'Open New',
    positionDirection: 'Current Position',
    long: 'Long (+)',
    short: 'Short (-)',
    rollSummary: 'Roll Summary',
    netPremium: 'Net Premium',
    oldPrice: 'Closing Price',
    newPrice: 'New Price',
  ...
  zh: {
    ...
    roll: '滚动/展期 (Roll)',
    rollAction: '期权展期',
    netCredit: '净收入 (Credit)',
    netDebit: '净支出 (Debit)',
    leg1: '平仓旧合约',
    leg2: '开仓新合约',
    positionDirection: '当前持仓方向',
    long: '持有 (Long +)',
    short: '卖空 (Short -)',
    rollSummary: '展期结算预览',
    netPremium: '净权利金',
    ...
    spread: '价差策略 (Spread)',
    spreadType: '策略类型',
    creditSpread: '净收入 (Credit)',
    debitSpread: '净支出 (Debit)',
    mainLeg: '主腿 (Main Leg)',
    hedgeLeg: '保护腿 (Hedge Leg)',
    sellLeg: '卖出腿 (Sell Leg)',
    buyLeg: '买入腿 (Buy Leg)',
    spreadSummary: '价差组合预览',
    failed: '录入交易失败',
