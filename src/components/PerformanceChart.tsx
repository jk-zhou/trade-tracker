...
export default function PerformanceChart({ data, dict, sp500Data, nasdaqData }: { data: DailyPerformance[], dict: Dict, sp500Data?: BenchmarkPoint[], nasdaqData?: BenchmarkPoint[] }) {
  ...
  return (
    <div className="bg-card border border-border p-4 md:p-6 rounded-xl shadow-sm mb-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h2 className="text-xl font-bold">{dict.performanceChart}</h2>
